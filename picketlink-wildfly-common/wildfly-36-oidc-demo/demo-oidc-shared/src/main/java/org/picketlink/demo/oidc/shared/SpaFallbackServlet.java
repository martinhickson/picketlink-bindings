 ...
 * <p>
 * The OIDC Authorization Server admin SPA ({@code as-ui}) uses
 * {@link org.picketlink.auth.oauth.servlet.VirtualResourcesServlet} instead; this servlet remains
 * for the relying-party demo ({@code rp-ui}).
 */
